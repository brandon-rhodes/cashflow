...
trn_date_entered = tag('trn:date-entered')
trn_description = tag('trn:description')
...
class Transaction(XMLWrapper):
    ...
    date_entered = XMLChildText(trn_date_entered, ts_date)
    description = XMLChildText(trn_description)
